<div class="space-y-10 divide-y divide-gray-900/10 overflow-y-auto">
<div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3">
  ...
  <form class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2 bg-sky-100">
