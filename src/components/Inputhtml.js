<form class="space-y-12 sm:space-y-16">
                ...
                <div class="max-w-lg">
                  ...
                  <div class="mt-6 space-y-6">
                    ...
                    <div class="flex items-center gap-x-3">
                      ...
                      <label for="push-nothing" class="block text-sm font-medium leading-6 text-gray-900 bg-blue-200 py-6 w-1 w-3 w-4 w-5 w-6 bg-gray-300">No push notifications</label>
                    </div>
                  </div>
                </div>
              </div>
